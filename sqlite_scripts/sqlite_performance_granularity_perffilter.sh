...
homeDir=/scratch/kapfhamm/perffilter_code
localDir=/local/kapfhamm/sqlite
sqliteDir=$localDir/TypeChef-SQLiteIfdeftoif
herculesDir=$localDir/Hercules

rm $herculesDir/block_performances.txt
cp $homeDir/block_performances.txt $herculesDir/block_performances.txt
